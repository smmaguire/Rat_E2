...
arc.mat<-arc[-83:-93,18:64] # column 11 is missing data.
...
#heatmap1 using pca
#is.matrix(fullMat)
#pdf("heatmap.pdf",height=20,width=20)
```

```{r fig.height=20, fig.width=20}
library(NeatMap)
make.heatmap1(as.matrix(scale(fullMat)),row.method="nMDS",column.method="nMDS",column.metric = "pearson",row.labels=rownames(fullMat),column.labels=colnames(fullMat))
```
...
print(levelplot(as.matrix(poa.fix.corgram),xlab=NULL,ylab=NULL,at=do.breaks(c(-1.01,1.01),101),scales=list(x=list(rot=90)),colorkey=list(space="top"),col.regions=colorRampPalette(c("gold","gray85","purple2"))))
```
...
print(levelplot(as.matrix(arc.fix.corgram),xlab=NULL,ylab=NULL,at=do.breaks(c(-1.01,1.01),101),scales=list(x=list(rot=90)),colorkey=list(space="top"),col.regions=colorRampPalette(c("gold","gray85","purple2"))))
```
...
print(levelplot(as.matrix(across.brain),xlab=NULL,ylab=NULL,at=do.breaks(c(-1.01,1.01),101),scales=list(x=list(rot=90)),colorkey=list(space="top"),col.regions=colorRampPalette(c("gold","gray85","purple2"))))
```
